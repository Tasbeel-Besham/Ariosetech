...
const PORTFOLIO_DB = [
  ...
  { slug: 'usb-estimating-wordpress', title: 'US Bidding Estimating', client: 'US Bidding Estimating', clientUrl: 'https://usbiddingestimatings.com', category: 'wordpress', summary: 'Construction estimating company with a custom bid calculator, project portal, and automated quote delivery.', challenge: 'Manual quoting process was slow and error-prone, causing lost leads.', solution: 'WordPress with a custom estimating plugin, automated PDF quotes, and client project portal.', quote: 'Our estimating process is now 10x faster and our close rate jumped significantly.', results: [{label:'Quote Speed',value:'10x faster'},{label:'Lead Conversion',value:'+45%'},{label:'Manual Work',value:'-70%'}], stack: ['WordPress','Custom Plugin','PDF Generation'], featured: false, published: true, updatedAt: new Date().toISOString() },
  { slug: 'cmadigital-wordpress', title: 'CMA Digital', client: 'CMA Digital', clientUrl: 'https://cmadigital.art', category: 'wordpress', summary: 'Creative digital agency portfolio site with animated case studies, custom project showcase, and lead funnel.', challenge: 'Needed a high-impact portfolio that converts visitors into discovery call bookings.', solution: 'Custom WordPress theme with scroll animations, filterable portfolio, and integrated Calendly booking.', quote: 'Our website finally matches the quality of our work. Inquiries doubled in the first month.', results: [{label:'Inquiry Rate',value:'+100%'},{label:'Bounce Rate',value:'-35%'},{label:'Avg. Session',value:'+2 min'}], stack: ['WordPress','GSAP','Calendly'], featured: false, published: true, updatedAt: new Date().toISOString() },
  { slug: 'zoompcohire-wordpress', title: 'Zoom PC Hire', client: 'Zoom PC Hire', clientUrl: 'https://zoompcohire.co.uk', category: 'wordpress', summary: 'UK-based IT equipment hire company with an online inventory system, real-time availability, and booking portal.', challenge: 'No online presence for bookings — all orders handled manually over the phone.', solution: 'WordPress with custom hire booking system, live inventory management, and automated confirmation emails.', quote: 'Online bookings now account for 60% of our revenue. Game-changing for our business.', results: [{label:'Online Revenue',value:'60% of total'},{label:'Admin Time',value:'-50%'},{label:'Bookings',value:'+180%'}], stack: ['WordPress','Custom Booking','WooCommerce'], featured: false, published: true, updatedAt: new Date().toISOString() },
  { slug: 'oceantech-wordpress', title: 'Ocean Tech BPO', client: 'Ocean Tech BPO', clientUrl: 'https://oceantech-globalbpo.com', category: 'wordpress', summary: 'Global BPO company with a services showcase, team profiles, client portal, and multi-region lead capture.', challenge: 'Needed a professional corporate site to attract enterprise clients globally.', solution: 'Custom WordPress site with animated hero, services matrix, case studies, and multi-language lead forms.', quote: 'The new site positioned us as a premium BPO provider. Enterprise inquiries tripled.', results: [{label:'Enterprise Leads',value:'+200%'},{label:'Time on Site',value:'+90s'},{label:'Bounce Rate',value:'-28%'}], stack: ['WordPress','WPML','Custom Theme'], featured: false, published: true, updatedAt: new Date().toISOString() },
  { slug: 'staffingocean-wordpress', title: 'Staffing Ocean', client: 'Staffing Ocean', clientUrl: 'https://staffingocean.com', category: 'wordpress', summary: 'Staffing and recruitment agency with job board, candidate portal, and employer dashboard built on WordPress.', challenge: 'Manual recruitment process with no online job listings or candidate tracking.', solution: 'WordPress with WP Job Manager, custom candidate profiles, and employer dashboard integration.', quote: 'We filled 3x more positions in the first quarter after the site launched.', results: [{label:'Placements',value:'+200%'},{label:'Candidates',value:'+350 in Q1'},{label:'Employer Signups',value:'+80%'}], stack: ['WordPress','WP Job Manager','Custom Portal'], featured: false, published: true, updatedAt: new Date().toISOString() },
  { slug: 'bgmgcosmetics-shopify', title: 'BGMG Cosmetics', client: 'BGMG Cosmetics', clientUrl: 'https://bgmgcosmetics.com', category: 'shopify', summary: 'Beauty and cosmetics brand on Shopify with custom product bundles, subscription boxes, and influencer affiliate program.', challenge: 'Needed subscription revenue model and an affiliate system to grow via influencers.', solution: 'Shopify with ReCharge subscriptions, custom bundle builder, and affiliate tracking integration.', quote: 'Subscription revenue now makes up 40% of our monthly income. Incredible results.', results: [{label:'Subscription Share',value:'40% of revenue'},{label:'AOV',value:'+55%'},{label:'Influencer Sales',value:'+120%'}], stack: ['Shopify','ReCharge','Affiliate App'], featured: false, published: true, updatedAt: new Date().toISOString() },
  { slug: 'accidentlaw-wordpress', title: 'Accident Law', client: 'Accident Law', clientUrl: 'https://accidentlaw.com', category: 'wordpress', summary: 'Personal injury law firm with a lead capture funnel, live chat integration, and case evaluation form.', challenge: 'Low online lead volume despite heavy ad spend — website was not converting.', solution: 'WordPress landing page redesign with trust signals, urgency elements, live chat, and multi-step form.', quote: 'Our cost per lead dropped by 60% after the redesign. The form converts incredibly well.', results: [{label:'Lead Cost',value:'-60%'},{label:'Form Conversion',value:'18%'},{label:'Monthly Leads',value:'+3x'}], stack: ['WordPress','Custom Theme','Live Chat'], featured: false, published: true, updatedAt: new Date().toISOString() },
  { slug: 'fabricwholesale-woocommerce', title: 'Fabric Wholesale', client: 'The Fabric Wholesale', clientUrl: 'https://thefabricwholesale.com', category: 'woocommerce', summary: 'UK fabric wholesale supplier with B2B pricing tiers, bulk order discounts, and trade account applications.', challenge: 'Needed to separate retail and wholesale pricing with a seamless B2B ordering experience.', solution: 'WooCommerce with role-based pricing, bulk discount rules, trade account applications, and PDF invoicing.', quote: 'Our wholesale orders doubled in three months. The trade portal is exactly what we needed.', results: [{label:'Wholesale Orders',value:'+100%'},{label:'Trade Signups',value:'+200'},{label:'AOV',value:'+80%'}], stack: ['WooCommerce','B2B Plugin','PDF Invoicing'], featured: false, published: true, updatedAt: new Date().toISOString() },
  { slug: 'deblackhole-wordpress', title: 'De Black Hole', client: 'De Black Hole', clientUrl: 'https://deblackhole.com', category: 'wordpress', summary: 'Creative entertainment brand with an immersive WordPress site featuring dark theme, video backgrounds, and event booking.', challenge: 'Required a visually stunning, performance-optimised site that matched a premium entertainment brand.', solution: 'Custom WordPress theme with video hero, parallax sections, event calendar, and integrated booking system.', quote: 'Our site now perfectly captures the experience we offer. Event bookings increased immediately.', results: [{label:'Event Bookings',value:'+150%'},{label:'PageSpeed',value:'91/100'},{label:'Brand Perception',value:'Premium'}], stack: ['WordPress','Custom Theme','Events Calendar'], featured: false, published: true, updatedAt: new Date().toISOString() },
]
