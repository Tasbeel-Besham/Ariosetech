...
const WP_BACKUP = { type: 'service-vertical', id: 'backup', tagline: 'Data Protection', title: 'WordPress Backup Solutions', desc: 'Never lose your WordPress data again. Automated, reliable backup solutions with one-click restore functionality, encrypted offsite storage, and flexible scheduling to protect everything you have built.', features: 'Automated daily backups,Multiple storage locations,One-click restore,Database & file backups,Incremental backup options,Encrypted secure storage', price: '$29/mo', timeline: 'Ongoing', visualType: 'score', align: 'right', score: 100, statusLabel: 'BACKUP VERIFIED' }
const WP_MULTILINGUAL = { type: 'service-vertical', id: 'multilingual', tagline: 'Global Reach', title: 'WordPress Multilingual Websites', desc: 'Expand your business globally with professionally developed multilingual WordPress websites. We support WPML, Polylang, and TranslatePress with full SEO configuration for each language, currency switching, and international UX.', features: 'Multiple language setup (WPML/Polylang),Language switcher design,International SEO per language,Currency switcher integration,RTL language support,Training on content management', price: '$899', timeline: '2-3 weeks', visualType: 'vitals', align: 'left', statusLabel: 'MULTILINGUAL READY' }
const WP_REDESIGN = { type: 'service-vertical', id: 'redesign', tagline: 'Fresh Start', title: 'WordPress Website Redesign', desc: 'Give your WordPress site a modern makeover. We audit your existing site, plan improvements based on your goals, create a conversion-focused design, and migrate all your content — without losing your SEO rankings.', features: 'Current site audit & competitor analysis,Modern mobile-first design,UX & navigation overhaul,Content migration & optimisation,SEO preservation,30 days of support', price: '$1,299', timeline: '3-4 weeks', visualType: 'score', align: 'right', score: 98, statusLabel: 'UX OPTIMISED' }
...
const wordpressLayout = { sections: [
  ...
  sec('stats', { items: [{ value: '99', label: 'Avg PageSpeed Score' }, { value: '150%', label: 'Conversion Increase' }, { value: '24h', label: 'Response Time' }, { value: '50+', label: 'WP Sites Managed' }] }),
  ...
  sec('service-vertical', { ...WP_BACKUP }),
  sec('service-vertical', { ...WP_MULTILINGUAL }),
  sec('service-vertical', { ...WP_REDESIGN }),
  sec('speed-score', { title: 'Core Web Vitals Optimization', desc: 'Boost your site speed by 40-70%. We optimise images, implement advanced caching, and perform server-level tuning for peak performance that directly improves Google rankings.', score: 99, statusLabel: 'CORE WEB VITALS PASS', metrics: [{label:'Time to Interactive',value:'0.8s'},{label:'Speed Index',value:'0.9s'}] }),
  sec('maintenance-plans', { title: 'Maintenance & Support Plans', subtitle: 'Proactive care for your WordPress infrastructure.', plans: [
    { tier: 'Basic', price: '$79/mo', desc: 'Essential maintenance for small websites', features: ['1 WordPress site', 'Monthly updates & backups', 'Basic security monitoring', 'Email support'], ctaLabel: 'Choose Basic', ctaHref: '/contact' },
    { tier: 'Professional', price: '$149/mo', desc: 'Comprehensive support for growing businesses', features: ['Up to 3 WordPress sites', 'Weekly updates & backups', 'Performance optimization', 'Priority email & chat support', 'Monthly performance reports'], isPopular: true, ctaLabel: 'Go Professional', ctaHref: '/contact' },
    { tier: 'Enterprise', price: '$299/mo', desc: 'Total peace of mind for high-traffic sites', features: ['Up to 10 WordPress sites', 'Real-time monitoring', 'Advanced security & malware removal', 'Speed optimization', '24/7 priority support'], ctaLabel: 'Contact Sales', ctaHref: '/contact' }
  ]}),
  sec('cyber-terminal', { tagline: 'Cyber Defense', title: 'Security & Virus Removal', desc: 'Emergency 24-48 hour virus removal plus comprehensive hardening. We clean infected files, remove from Google Blacklist, and install permanent protection so it never happens again.', price: '$199', features: ['Malware Identification & Removal', 'Infected File Cleaning', 'Google Blacklist Removal', 'Security Hardening', '30-Day Monitoring'], statusText: 'root@ariosetech:~/security_audit' }),
  ...
  sec('portfolio', { eyebrow: 'Our Work', headline: 'WordPress Success Stories', intro: "Real results from WordPress sites we have built, optimised, and grown.", items: PORTFOLIO_ITEMS.filter(p => p.platform?.includes('WordPress')), ctaLabel: 'View All Projects', ctaHref: '/portfolio' }),
  sec('testimonials', { eyebrow: 'Client Reviews', headline: 'What Our WordPress Clients Say', items: TESTIMONIALS }),
  sec('faq', { eyebrow: 'WordPress FAQ', headline: 'Frequently Asked Questions', items: [
  ...
  sec('cta', { eyebrow: 'Get Started', headline: 'Ready to Build Your WordPress Site?', desc: 'Get a free consultation and detailed project quote within 24 hours. No commitment required.', trust: CTA_TRUST, ctaLabel: 'Get Free Consultation', ctaHref: '/contact', secondaryLabel: 'View Our Portfolio', secondaryHref: '/portfolio' }),
]}

const WC_MIGRATION = { type: 'service-vertical', tagline: 'Zero Downtime', title: 'WooCommerce Migration Services', desc: 'Moving your store to WooCommerce? We handle the complete migration — products, customers, orders, SEO redirects — with zero data loss and minimal downtime. From Shopify, Magento, OpenCart, PrestaShop, or any custom platform.', features: 'Complete product & order migration,Customer accounts & order history,SEO preservation with 301 redirects,Payment & shipping reconfiguration,Design recreation or improvement,30 days post-migration support', price: '$999', timeline: '1-3 weeks', visualType: 'score', align: 'right', score: 100, statusLabel: 'ZERO DATA LOSS' }
const WC_MULTILINGUAL = { type: 'service-vertical', tagline: 'Global Commerce', title: 'WooCommerce Multilingual Websites', desc: 'Reach international customers with a seamlessly multilingual WooCommerce store. Multiple languages, currencies, local payment gateways, and region-specific shipping — all managed from one dashboard.', features: 'Unlimited language support (WPML/Polylang),Multi-currency with auto conversion,Country-specific payment gateways,RTL language support,International SEO configuration,Translated checkout & product pages', price: '$1,499', timeline: '3-4 weeks', visualType: 'vitals', align: 'left', statusLabel: 'GLOBAL READY' }

const woocommerceLayout = { sections: [
  sec('hero', { eyebrow: 'WooCommerce Services', headline: 'Custom WooCommerce Development Services', subheadline: "Turn your vision into a profitable online store. Custom WooCommerce solutions with seamless payment integration and conversion optimization. Starting at $1,299.", supportingText: '30-Day Money-Back Guarantee · Free Post-Launch Support · Free Consultation', ctaPrimaryLabel: 'Get Free WooCommerce Quote', ctaPrimaryHref: '/contact', ctaSecondaryLabel: 'View WooCommerce Portfolio', ctaSecondaryHref: '/portfolio', trust: 'Store Setup & Customization,Payment Gateway Integration,Multi-vendor Solutions,Performance Optimization,Multilingual & Migration' }),
  ...
  sec('service-vertical', { ...WC_MIGRATION }),
  sec('service-vertical', { ...WC_MULTILINGUAL }),
  ...
  sec('maintenance-plans', { title: 'Maintenance & Support Plans', subtitle: 'Proactive care for your WooCommerce store.', plans: [
    { tier: 'Essential', price: '$129/mo', desc: 'Basic protection for growing stores', features: ['Monthly Updates', 'Security Monitoring', 'Basic Support (48h)', 'Daily Backups', '2h Modifications'], ctaLabel: 'Get Started', ctaHref: '/contact' },
    { tier: 'Professional', price: '$249/mo', desc: 'High performance for busy stores', features: ['Weekly Updates', 'Speed Optimization', 'Priority Support (24h)', 'Real-time Backups', '5h Modifications', 'Monthly Reports'], isPopular: true, ctaLabel: 'Go Professional', ctaHref: '/contact' },
    { tier: 'Enterprise', price: '$499/mo', desc: 'Full management for high-volume stores', features: ['Daily Updates', 'Advanced Security', 'Dedicated Support (24/7)', 'Full Backups', '10h Modifications', 'Custom Development'], ctaLabel: 'Talk to Expert', ctaHref: '/contact' }
  ]}),
  sec('cyber-terminal', { tagline: 'Cyber Defense', title: 'Security & Malware Removal', desc: 'Protect your store from evolving threats with 24/7 monitoring and emergency security services. PCI-compliant hardening for e-commerce peace of mind.', price: '$249', features: ['Malware Scanning & Removal', 'Firewall Hardening', 'Vulnerability Assessment', 'PCI Compliance Check', '30-Day Monitoring'], statusText: 'root@ariosetech:~/wc_security_audit' }),
  sec('whyus', { eyebrow: 'Why Choose Us', headline: 'Why 100+ Businesses Trust ARIOSETECH for Their Success', items: WHY_ITEMS.map(s => ({ ...s, icon: '' })) }),
  sec('process', { eyebrow: 'How We Work', headline: 'Our WooCommerce Development Process', steps: PROCESS_STEPS }),
  sec('portfolio', { eyebrow: 'Our Work', headline: 'WooCommerce Success Stories', intro: "Real results from real WooCommerce stores we have built and grown.", items: PORTFOLIO_ITEMS.filter(p => p.platform?.includes('WooCommerce')), ctaLabel: 'View All Projects', ctaHref: '/portfolio' }),
  sec('testimonials', { eyebrow: 'Client Reviews', headline: 'What Our WooCommerce Clients Say', items: TESTIMONIALS }),
  sec('faq', { eyebrow: 'WooCommerce FAQ', headline: 'Frequently Asked Questions', items: [
    { q: 'How much does a WooCommerce store cost?', a: 'Custom WooCommerce development starts at $1,299 for a standard store. Complex stores with advanced features, multi-vendor, or multilingual functionality range from $2,000–$5,000+. We provide a detailed quote after your free consultation.' },
    { q: 'How long does WooCommerce development take?', a: 'Most WooCommerce stores are completed in 3-5 weeks. Complex stores with extensive customisation may take 6-8 weeks. We always provide a realistic timeline after reviewing your requirements.' },
    { q: 'Can you migrate my store from Shopify or another platform?', a: 'Yes. We provide complete migration services from Shopify, Magento, OpenCart, PrestaShop, BigCommerce, and custom platforms — including all products, customers, orders, and SEO redirects.' },
    ...
    { q: 'Can WooCommerce handle large product catalogs?', a: 'Yes. WooCommerce can handle thousands of products when properly optimised. We implement database and caching optimisations specifically designed for large-scale stores.' },
    { q: 'Do you offer ongoing WooCommerce support?', a: 'Every project includes 30 days of free post-launch support. After that, we offer monthly maintenance plans starting at $129/month covering updates, backups, security monitoring, and priority support.' },
  ] }),
  sec('cta', { eyebrow: 'Get Started', headline: 'Ready to Launch Your WooCommerce Store?', desc: 'Get a free consultation and detailed quote within 24 hours. No commitment required.', trust: CTA_TRUST, ctaLabel: 'Start Your Store', ctaHref: '/contact', secondaryLabel: 'View Our Portfolio', secondaryHref: '/portfolio' }),
]}

const SHOPIFY_SERVICES_FULL = [
  { icon: '🚀', title: 'Shopify Store Development', headline: 'Professional Stores Built for Growth', desc: 'Custom Shopify stores with conversion-optimized design, fast performance, and seamless UX from day one.', features: 'Custom Shopify theme development,Product catalog and collections setup,Payment gateway configuration,Shipping and tax setup,SEO-optimized product pages,30 days of free support', price: '$999', href: '/contact' },
  { icon: '⭐', title: 'Shopify Plus Development', headline: 'Enterprise-Grade for High-Volume Brands', desc: 'Advanced Shopify Plus solutions for enterprise brands — custom checkout, B2B features, and advanced automation.', features: 'Custom checkout with Extensibility,B2B and wholesale portal,Multi-store management,Advanced automation flows,Custom app development,Dedicated account management', price: '$2,999', href: '/contact' },
  { icon: '🔀', title: 'Shopify Migration Services', headline: 'Seamless Migration to Shopify', desc: 'Moving your store to Shopify? We migrate all products, customers, orders, and SEO settings with zero downtime and zero data loss.', features: 'All product data & images,Customer accounts & order history,SEO settings & 301 redirects,Payment & shipping config,Theme recreation or redesign,30-day post-migration support', price: '$799', href: '/contact' },
  { icon: '⚡', title: 'Shopify Performance Optimization', headline: 'Faster Store = More Sales', desc: 'Speed up your Shopify store for better conversions. Every second of delay costs sales.', features: 'Liquid code optimization,Image compression and lazy loading,App audit and removal,Core Web Vitals improvement,Checkout page speed boost,Performance report before & after', price: '$499', href: '/contact' },
  { icon: '🎨', title: 'Shopify Store Redesign', headline: 'Modern Design Without Losing Data', desc: 'Modernize your Shopify store with a fresh design, improved navigation, and better conversion rates — keeping all your data safe.', features: 'Custom theme redesign,Improved UX and navigation,Brand identity alignment,Mobile responsiveness,Product page optimization,Speed optimization included', price: '$1,499', href: '/contact' },
  { icon: '🔗', title: 'Shopify App & Integration', headline: 'Connect Any Tool to Your Store', desc: 'Connect your Shopify store with any third-party tool — CRM, ERP, email marketing, shipping, or custom private apps built from scratch.', features: 'Third-party app integration,Custom API connections,Zapier and Make automation,Email marketing integration,Inventory system sync,Custom private app development', price: '$399+', href: '/contact' },
  { icon: '🔧', title: 'Shopify Maintenance & Support', headline: 'Always-On Expert Support', desc: 'Keep your Shopify store running smoothly with regular updates, monitoring, and expert support whenever you need it.', features: 'Monthly store health check,App updates and management,Content and product updates,Bug fixes and troubleshooting,Performance monitoring,Priority support channel', price: '$99/mo', href: '/contact' },
]

const SHOPIFY_APP_DEV = { type: 'service-vertical', tagline: 'Custom Functionality', title: 'Shopify App Development', desc: "Need functionality that doesn't exist in the App Store? We build custom private apps and public Shopify apps tailored to your specific business requirements — from product configurators to B2B portals and advanced automation tools.", features: 'Custom private app development,Public App Store apps,Custom product configurators,Subscription & recurring billing,Advanced search & filtering,Loyalty & rewards programs,B2B pricing & catalogs,Multi-vendor marketplace apps', price: '$1,999', timeline: '4-8 weeks', visualType: 'terminal', align: 'right', statusText: 'root@ariosetech:~/shopify_app_build' }

const shopifyLayout = { sections: [
  sec('hero', { eyebrow: 'Shopify Services', headline: 'Professional Shopify Development Services', subheadline: 'Scale your business with Shopify. From startup stores to Shopify Plus enterprises, we deliver results that matter. Starting at $999.', supportingText: '30-Day Money-Back Guarantee · Free Post-Launch Training · Shopify Partner', ctaPrimaryLabel: 'Get Free Shopify Consultation', ctaPrimaryHref: '/contact', ctaSecondaryLabel: 'View Shopify Portfolio', ctaSecondaryHref: '/portfolio', trust: 'Custom Store Development,Shopify Plus Solutions,App Development,Migration Services,Conversion Optimization' }),
  sec('stats', { items: [{ value: 'Partner', label: 'Official Shopify Partner' }, { value: '250%', label: 'Avg Sales Increase' }, { value: '40+', label: 'Apps Integrated' }, { value: '99.9%', label: 'Store Uptime' }] }),
  sec('services', { eyebrow: 'All Services', headline: 'Complete Shopify Solutions for Every Business Need', items: SHOPIFY_SERVICES_FULL.map(s => ({ ...s, icon: '' })) }),
  sec('service-vertical', { ...SHOPIFY_APP_DEV }),
  sec('speed-score', { title: 'Shopify Performance Optimization', desc: 'Improve your store speed by 40-60%. We optimise theme code, audit app performance, and tune assets for maximum conversion rate.', score: 99, statusLabel: 'LIQUID OPTIMIZED', metrics: [{label:'Mobile Performance',value:'90+'},{label:'Desktop Performance',value:'99+'}] }),
  sec('maintenance-plans', { title: 'Shopify Maintenance & Support', subtitle: 'Proactive care for your Shopify ecosystem.', plans: [
    { tier: 'Starter', price: '$99/mo', desc: 'Essential care for growing stores', features: ['Monthly Updates', 'App Monitoring', 'Email Support', '2h Modifications'], ctaLabel: 'Choose Starter', ctaHref: '/contact' },
    { tier: 'Growth', price: '$199/mo', desc: 'Performance care for busy stores', features: ['Bi-weekly Updates', 'Speed Optimization', 'Priority Support', '5h Modifications', 'Monthly Reports'], isPopular: true, ctaLabel: 'Go Growth', ctaHref: '/contact' },
    { tier: 'Enterprise', price: '$399/mo', desc: 'Full management for high-volume brands', features: ['Weekly Updates', 'Custom Development', '24/7 Priority Support', '10h Modifications', 'Dedicated Manager'], ctaLabel: 'Contact Sales', ctaHref: '/contact' }
  ]}),
  sec('cyber-terminal', { tagline: 'Cyber Defense', title: 'Shopify Security Hardening', desc: 'Protect your store from evolving threats with advanced security configurations, app audits, and fraud protection setup.', price: '$149', features: ['Security App Audit', '2FA Implementation', 'Checkout Hardening', 'Fraud Protection Setup', 'App Permission Review'], statusText: 'root@ariosetech:~/shopify_audit' }),
  sec('whyus', { eyebrow: 'Why Choose Us', headline: 'Why 100+ Businesses Trust ARIOSETECH for Their Success', items: WHY_ITEMS.map(s => ({ ...s, icon: '' })) }),
  sec('process', { eyebrow: 'How We Work', headline: 'Our Shopify Development Process', steps: PROCESS_STEPS }),
  sec('portfolio', { eyebrow: 'Our Work', headline: 'Shopify Success Stories', intro: "Real results from real Shopify stores we have built and scaled.", items: PORTFOLIO_ITEMS.filter(p => p.platform?.includes('Shopify')), ctaLabel: 'View All Projects', ctaHref: '/portfolio' }),
  sec('testimonials', { eyebrow: 'Client Reviews', headline: 'What Our Shopify Clients Say', items: TESTIMONIALS }),
  sec('faq', { eyebrow: 'Shopify FAQ', headline: 'Frequently Asked Questions', items: [
    { q: 'How long does it take to build a Shopify store?', a: 'Most custom Shopify stores are completed in 2-4 weeks. Shopify Plus projects with enterprise requirements typically take 4-6 weeks depending on complexity.' },
    { q: 'Can you migrate my existing store to Shopify?', a: 'Yes. We provide complete migration services from WooCommerce, Magento, BigCommerce, and custom platforms — preserving all product data, customer records, order history, and SEO settings.' },
    { q: 'Do you work with Shopify Plus?', a: 'Yes. We have extensive Shopify Plus experience including custom checkout extensibility, B2B wholesale portals, multi-store setups, and advanced Shopify Flow automation.' },
    { q: 'Can you develop custom Shopify apps?', a: 'Absolutely. We build both private apps for individual stores and public apps for the Shopify App Store using the latest Shopify APIs, GraphQL, and React.' },
    { q: 'What is included in post-launch support?', a: 'All Shopify projects include 30 days of free support covering bug fixes, minor adjustments, training, and guidance on store management.' },
    { q: 'How much does Shopify maintenance cost?', a: 'Our Shopify maintenance plans start at $99/month and include store health checks, app updates, bug fixes, content updates, and priority support.' },
    { q: 'Do you help with Shopify SEO?', a: 'Yes. Every store we build includes basic SEO optimisation. We also offer dedicated Shopify SEO services covering technical SEO, product page optimisation, and content strategy.' },
  ] }),
  sec('cta', { eyebrow: 'Get Started', headline: 'Ready to Launch Your Shopify Store?', desc: 'Get a free consultation and detailed quote within 24 hours. No commitment required.', trust: CTA_TRUST, ctaLabel: 'Start Your Store', ctaHref: '/contact', secondaryLabel: 'View Our Portfolio', secondaryHref: '/portfolio' }),
]}

const seoLayout = { sections: [
  sec('hero', { eyebrow: 'SEO Services', headline: 'Get Found on Google. Drive Real Organic Traffic.', subheadline: "Expert SEO services for WordPress, WooCommerce, and Shopify. We don't just improve rankings — we drive qualified traffic that converts into paying customers.", supportingText: 'Free 25-point audit · No contracts · Results in 90 days or money back', ctaPrimaryLabel: 'Get Free SEO Audit', ctaPrimaryHref: '/contact', ctaSecondaryLabel: 'View Case Studies', ctaSecondaryHref: '/portfolio', trust: 'Technical SEO,On-Page Optimization,E-Commerce SEO,Local SEO,Content Strategy' }),
  sec('stats', { items: [{ value: '+312%', label: 'Avg Organic Traffic Increase' }, { value: 'Top 3', label: 'Google Rankings' }, { value: '-45%', label: 'Bounce Rate Reduction' }, { value: '90 days', label: 'Avg to First Results' }] }),
  sec('service-vertical', { id: 'website-seo', tagline: 'Foundation First', title: 'Website SEO', desc: 'We improve the on-page SEO and structural setup of your website so search engines can better understand your content and users can navigate clearly. Includes heading structure, metadata, content optimisation, internal linking, keyword mapping, and overall SEO alignment.', features: 'On-page SEO improvements,Page-level keyword targeting,Heading and content structure,Metadata optimisation,Internal linking strategy,Google Search Console setup,Keyword mapping and gap analysis,Monthly ranking reports', price: '$299', timeline: '2-3 weeks', visualType: 'score', align: 'left', score: 97, statusLabel: 'ON-PAGE OPTIMISED', metrics: [{label:'Starting from',value:'$299'},{label:'Timeline',value:'2-3 weeks'}] }),
  sec('service-vertical', { id: 'local-seo', tagline: 'Dominate Your Area', title: 'Local SEO', desc: 'Rank at the top of Google when local customers search for your services. We optimise your Google Business Profile, build local citations, create location-specific content, and ensure you appear in the local map pack for every relevant search.', features: 'Google Business Profile optimisation,Local keyword research and targeting,Local citation building,Location page creation,Review management strategy,Local schema markup,Competitor local analysis,Rank tracking for local terms', price: '$399/mo', timeline: '3-6 months', visualType: 'vitals', align: 'right', statusLabel: 'LOCAL PACK READY', metrics: [{label:'Starting from',value:'$399/mo'},{label:'Timeline',value:'3-6 months'}] }),
  sec('service-vertical', { id: 'technical-seo', tagline: 'Under The Hood', title: 'Technical SEO', desc: 'Fix the technical issues that prevent Google from properly crawling and indexing your site. Comprehensive audit covering speed, Core Web Vitals, crawlability, structured data, mobile-friendliness — then we fix every issue we find.', features: 'Comprehensive technical site audit,Crawl error identification and fixing,XML sitemap and robots.txt optimisation,Core Web Vitals improvement,Structured data / schema markup,Canonical tag implementation,Redirect chain fixing,Mobile-friendliness improvements', price: '$499', timeline: '2-4 weeks', visualType: 'score', align: 'left', score: 99, statusLabel: 'TECHNICAL PASS', metrics: [{label:'Investment',value:'$499'},{label:'Timeline',value:'2-4 weeks'}] }),
  sec('service-vertical', { id: 'content-seo', tagline: 'Content That Ranks', title: 'SEO Content Strategy', desc: 'Research your market, identify high-value keyword opportunities competitors are missing, and create or optimise content that ranks — driving qualified organic traffic that converts into customers month after month.', features: 'Keyword research and opportunity mapping,Competitor content gap analysis,Content brief creation per page,Blog post and landing page optimisation,Content calendar planning,Internal linking optimisation,E-E-A-T improvements,Monthly content performance reports', price: '$599/mo', timeline: 'Ongoing', visualType: 'vitals', align: 'right', statusLabel: 'CONTENT OPTIMISED', metrics: [{label:'Starting from',value:'$599/mo'},{label:'Min. Term',value:'3 months'}] }),
  sec('whyus', { eyebrow: 'Why SEO With Us', headline: 'SEO is Your Best Long-Term Investment', items: [
    { icon: '📈', title: 'Compounds Over Time', subhead: 'Results Build Month After Month', desc: 'Unlike paid ads that stop when you stop paying, SEO builds momentum. Every month of work compounds on the last.' },
    { icon: '🎯', title: 'Qualified Traffic Only', subhead: 'Buyers, Not Just Browsers', desc: 'People searching for your services are already interested. SEO brings qualified leads ready to buy — not random visitors.' },
    { icon: '💰', title: 'Highest Marketing ROI', subhead: '748% Average Return', desc: 'Average SEO ROI is 748%. No other marketing channel delivers this level of compounding return over 12-24 months.' },
    { icon: '🔍', title: 'Full Transparency', subhead: 'Monthly Reports, Clear Metrics', desc: 'Detailed monthly reports showing rankings improved, traffic increased, and what comes next — no black box.' },
  ]}),
  sec('process', { eyebrow: 'How We Work', headline: 'Our SEO Process', steps: [
    { n: '01', title: 'Audit & Strategy', sub: 'Discover What Is Holding You Back', desc: 'Comprehensive 25-point audit covering technical SEO, on-page, content gaps, and competitor analysis.', time: '1 week' },
    { n: '02', title: 'Keyword Research', sub: 'Find Your Winning Opportunities', desc: 'In-depth research to identify high-value terms your target customers are actively searching for.', time: '1 week' },
    { n: '03', title: 'On-Page Optimisation', sub: 'Fix and Improve Every Page', desc: 'Implement all on-page and technical improvements to align your site with search engine best practices.', time: '2-3 weeks' },
    { n: '04', title: 'Content & Links', sub: 'Build Authority Over Time', desc: 'Ongoing content creation and link building to grow your site authority and rankings each month.', time: 'Ongoing' },
    { n: '05', title: 'Report & Refine', sub: 'Monthly Progress Updates', desc: 'Detailed monthly reports with ranking changes, traffic growth, and next-month action plan.', time: 'Monthly' },
  ]}),
  sec('testimonials', { eyebrow: 'Client Reviews', headline: 'What Our SEO Clients Say', items: TESTIMONIALS }),
  sec('faq', { eyebrow: 'SEO FAQ', headline: 'Frequently Asked Questions About SEO', items: [
    { q: 'How long does SEO take to show results?', a: 'SEO typically shows meaningful results within 3-6 months. Technical improvements can be seen quickly, but significant ranking and traffic increases usually take 3-6 months of consistent work.' },
    { q: 'How much does your SEO service cost?', a: 'Website SEO starts at $299 one-time, Technical SEO at $499, Local SEO from $399/month, and Content SEO from $599/month. We provide a custom quote based on your goals and competition level.' },
    { q: 'Do you guarantee first page rankings?', a: 'No legitimate SEO agency can guarantee specific rankings. We guarantee measurable improvement in your organic traffic, visibility, and keyword rankings over time — backed by monthly reports.' },
    { q: 'Do you work with WordPress, Shopify, and WooCommerce?', a: 'Yes — we specialise in SEO for all three platforms. We understand the technical nuances of each and implement platform-specific optimisations that generalist agencies miss.' },
    { q: 'What is included in the free SEO audit?', a: 'Our free 25-point audit covers site speed, Core Web Vitals, crawlability, indexing, on-page factors, keyword rankings, competitor comparison, and a prioritised list of fixes.' },
    { q: 'Is SEO worth it for a small business?', a: 'Absolutely. SEO helps small businesses appear when customers are actively searching for their services — driving qualified free traffic without ongoing ad spend. The ROI compounds over time.' },
  ]}),
  sec('cta', { eyebrow: 'Get Started', headline: 'Ready to Dominate Google Search?', desc: 'Get a free 25-point SEO audit and discover exactly what is holding your site back from ranking #1.', trust: CTA_TRUST, ctaLabel: 'Get Free SEO Audit', ctaHref: '/contact', secondaryLabel: 'View Case Studies', secondaryHref: '/portfolio' }),
]}
