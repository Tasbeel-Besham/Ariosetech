      ...
      <section className="section" style={{ overflow: 'visible' }}>
        <div className="container">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }} className="md:flex-row md:items-start lg:gap-24">
            ...
            {/* LEFT — sticky */}
            <div className="relative md:sticky md:top-[88px] shrink-0 md:w-1/3">
              <p className="eyebrow sr">Why Choose Us</p>
              <h2 className="sr" style={{ ...F, fontSize:'clamp(1.8rem,3.5vw,2.6rem)', fontWeight:800, lineHeight:1.1, letterSpacing:'-0.03em', color:'#fff', marginBottom:'20px' }}>
            ...
            {/* RIGHT — cards grid */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px' }} className="md:w-2/3">
              {WHY_US.map((b,i) => (
                <div key={b.title} className="sr" style={{ background:'var(--bg-2)', border:'1px solid var(--border)', borderRadius:'20px', padding:'26px', transition:'all 0.25s var(--ease)', animationDelay:`${i*0.08}s` }}
                  ...
                  <div style={{ marginBottom:'14px', display:'flex', alignItems:'center', justifyContent:'center', width:'48px', height:'48px', borderRadius:'12px', background:'rgba(118,108,255,0.1)', color:'var(--primary)' }}>
                    {b.icon}
                  </div>
