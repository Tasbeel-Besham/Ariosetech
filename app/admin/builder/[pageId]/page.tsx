        ...
        <div className='builder-canvas flex-1 overflow-y-auto bg-bg relative'>
          {layout.sections.length === 0 ? (
            <div className="flex flex-col items-center justify-center min-h-[80%] gap-4 p-8">
              <div className="w-16 h-16 rounded-[var(--radius-xl)] bg-[rgba(var(--primary-rgb),0.1)] border border-[rgba(var(--primary-rgb),0.2)] flex items-center justify-center">
              ...
              <div className="text-center">
                ...
                <button onClick={() => setPickerOpen(true)} className="inline-flex items-center gap-2 py-3 px-6 rounded-lg border-none bg-gradient-to-br from-primary to-primary-dark text-white text-sm font-bold font-display cursor-pointer transition-opacity hover:opacity-90">
            ...
            <>
              ...
              <div className="p-6 flex justify-center">
                <button onClick={() => setPickerOpen(true)} className="flex items-center gap-2 py-2.5 px-5 rounded-md border border-dashed border-border-2 bg-transparent text-text-3 cursor-pointer text-[13px] font-body transition-all hover:border-[rgba(var(--primary-rgb),0.5)] hover:text-primary">
