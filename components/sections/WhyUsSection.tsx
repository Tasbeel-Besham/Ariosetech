                ...
                <div className="flex items-center gap-20 mb-32 relative">
                  ...
                  {(b.price || b.href) && (
                    <div className="ml-auto flex items-center gap-24">
                      ...
                      {b.href && (
                        <Link href={b.href} className="btn btn-primary btn-md shrink-0 uppercase tracking-wider text-sm">
                          Get Started
                        </Link>
                      )}
                    </div>
            ...
            {safe.map((b, i) => (
              ...
              >
                ...
                <div className="premium-row__cta-col flex flex-col items-end justify-center gap-16 h-full pl-32">
                  ...
                  {b.href && (
                    <Link href={b.href} className="btn btn-primary btn-md w-full justify-center text-center uppercase tracking-wider text-sm">
                      Get Started
                    </Link>
                  )}
                </div>
                ...
                <div className="flex flex-col grow-1">
                  ...
                  {(b.price || b.href) && (
                    <div className="mt-auto pt-16 flex items-center justify-between gap-12 card-divider">
                      ...
                      {b.href && (
                        <Link href={b.href} className="btn btn-primary btn-sm uppercase tracking-wider text-xs">
                          Get Started
                        </Link>
                      )}
                    </div>
