...
function useW() {
  ...
  useEffect(() => { const s = () => setW(window.innerWidth); s(); window.addEventListener('resize', s); return () => window.removeEventListener('resize', s) }, [])
  return w
}

const Check = () => <svg width="10" height="10" viewBox="0 0 12 12" fill="none"><path d="M2 6l3 3 5-6" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"/></svg>
const Arrow = () => <svg width="13" height="13" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/></svg>
    ...
    <section className="section section--dark">
      <div className="container">
        ...
        <div style={{
          ...
          {/* ── Tab strip (left on desktop, top on mobile) ── */}
          <div style={{
            display: 'flex',
