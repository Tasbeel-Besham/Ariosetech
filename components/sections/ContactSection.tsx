  ...
  return (
    <section className="section">
      <div className="container">
        ...
        <div className="g grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-[20px] max-w-[900px] mx-auto">
          {[{ icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>, label: 'Email', value: email, desc: emailDesc, href: `mailto:${email}` }, 
            ...
            <div key={label} className="card-hover bg-subtle-2 border-subtle p-40 text-center flex flex-col items-center justify-center relative overflow-hidden rounded-[16px]">
              <div className="absolute top-0 left-0 w-full bg-grad h-[3px]" />
