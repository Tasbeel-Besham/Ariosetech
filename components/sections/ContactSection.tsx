    ...
    <section className="section">
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px', maxWidth: '900px', margin: '0 auto' }}>
          {[{ icon: '📧', label: 'Email', value: email, desc: emailDesc, href: `mailto:${email}` }, 
            { icon: '📱', label: 'Phone/WhatsApp', value: phone, desc: phoneDesc, href: `tel:${cleanPhone}` }, 
            { icon: '🏢', label: 'Address', value: address, desc: addressDesc, href: undefined }].map(({ icon, label, value, desc, href }) => (
