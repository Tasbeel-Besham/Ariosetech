...
import IndustryDirectorySection from '@/components/sections/IndustryDirectorySection'
...
export function initRegistry() {
  ...
  registerSection({
    ...
    defaultProps: {
      ...
      items: [
        { icon: 'wordpress', title: 'WordPress Development', tagline: 'Powerful, scalable websites', price: 'From $799',
        ...
        { icon: 'cart', title: 'WooCommerce Development', tagline: 'Stores built to sell', price: 'From $1,299',
        ...
        { icon: 'store', title: 'Shopify Development', tagline: 'Scale without limits', price: 'From $999',
        ...
        { icon: 'seo', title: 'SEO Services', tagline: 'Get found faster', price: 'Custom',
    ...
    schema: [
      ...
      { type: 'textarea', name: 'intro',      label: 'Intro paragraph' },
      { type: 'repeater', name: 'items',      label: 'Services', fields: [
        { type: 'select',   name: 'icon',     label: 'Icon', options: ['wordpress','cart','store','seo','code','rocket','chart','gear'] },
        { type: 'text',     name: 'title',    label: 'Service title' },
        { type: 'text',     name: 'tagline',  label: 'Short tagline' },
        { type: 'textarea', name: 'desc',     label: 'Description' },
        { type: 'textarea', name: 'features', label: 'Features (comma separated)' },
  ...
  registerSection({
    ...
    schema: [
      ...
      { type: 'select',   name: 'layout',   label: 'Layout Variant', options: ['split', 'grid', 'rows', 'bento-table'] },
  ...
  registerSection({
    ...
    schema: [
      ...
      { type: 'repeater', name: 'items', label: 'Projects', fields: [
        ...
        { type: 'text',     name: 'client',      label: 'Client / description' },
        { type: 'text',     name: 'platform',    label: 'Platform (e.g. Custom WooCommerce)' },
  ...
  registerSection({
    ...
    icon: '\u{1F9ED}',
    component: IndustryDirectorySection as C,
    defaultProps: {
      headingTag: 'h2',
      eyebrow: 'Industries',
    ...
    schema: [
      { type: 'select',   name: 'headingTag', label: 'Heading tag (SEO)', options: ['h2','h3','h1'] },
      { type: 'text',     name: 'eyebrow',    label: 'Eyebrow' },
      { type: 'textarea', name: 'headline',   label: 'Headline' },
      { type: 'textarea', name: 'intro',      label: 'Intro paragraph' },
      { type: 'text',     name: 'countLabel', label: 'Count badge (optional)' },
      { type: 'repeater', name: 'items', label: 'Industries (leave empty for defaults)', fields: [
        { type: 'text',     name: 'name', label: 'Industry name' },
        { type: 'text',     name: 'href', label: 'Link (e.g. /industries/fashion-apparel)' },
        { type: 'textarea', name: 'note', label: 'One-line descriptor' },
        { type: 'text',     name: 'tags', label: 'Platform tags (optional)' },
      ]},
    ],
  })
