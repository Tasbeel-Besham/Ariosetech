  ...
  const sections = [
    ...
    },
    {
      ...
      props: {
        ...
        steps: [
          { n: '01', title: 'Audit & Strategy', sub: 'Discover What Is Holding You Back', desc: 'We review your website, search presence, content, and technical condition to understand what is holding performance back.' },
          { n: '02', title: 'Keyword Research', sub: 'Find Your Winning Opportunities', desc: 'We build an SEO plan based on your business model, audience, goals, and search opportunities.' },
          { n: '03', title: 'On-Page Optimization', sub: 'Fix and Improve Every Page', desc: 'We improve your pages, structure, technical setup, content targeting, and internal SEO foundation.' },
          { n: '04', title: 'Content & Growth', sub: 'Build Authority Over Time', desc: 'Where needed, we build supporting content, improve weak pages, and strengthen site-wide relevance.' },
          { n: '05', title: 'Report & Refine', sub: 'Monthly Progress Updates', desc: 'SEO is not static. We continue refining based on performance, search trends, and growth priorities.' }
        ]
      }
    },
    {
