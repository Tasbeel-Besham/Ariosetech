    ...
    const sections = [
      ...
      },
      {
        ...
        props: {
          ...
          items: ${JSON.stringify(WP_SERVICES_ITEMS.slice(0, 4), null, 2)}
        }
      },
      {
        id: new ObjectId().toHexString(),
        ...
        props: {
          ...
          layout: 'grid',
          items: ${JSON.stringify(WP_SERVICES_ITEMS.slice(4, 7).map(item => ({
            icon: item.icon,
            title: item.title,
            subhead: item.sub,
            desc: item.desc,
      ...
      },
      {
        ...
        props: {
          ...
          layout: 'rows',
          items: ${JSON.stringify(WP_SERVICES_ITEMS.slice(7).map(item => ({
            icon: item.icon,
            title: item.title,
            subhead: item.sub,
            desc: item.desc,
...
const wordpressLayout = { sections: [
  ...
  sec('services-accordion', { eyebrow: 'Our Services', headline: 'Complete WordPress Solutions for Every Business Need', intro: 'From custom themes to complex functionality, we create WordPress sites that grow with your business. Speed-optimized, secure, and SEO-ready.', items: ${JSON.stringify(WP_SERVICES_ITEMS.slice(0, 4), null, 2)} }),
  sec('whyus', {
    eyebrow: 'Performance & Defense',
    headline: 'WordPress Security & Speed Optimization',
    desc: 'Keep your website loading instantly and fully protected from threats with our performance and security hardening solutions.',
